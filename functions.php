...
function h5bs_enqueue_styles() {
    ...
    wp_register_style( 'font-awesome', get_template_directory_uri() .'/bower_components/font-awesome/css/font-awesome.css' );
    wp_register_style( 'animate', get_template_directory_uri() .'/bower_components/animate.css/animate.css' );
...
function h5bs_enqueue_scripts() {
    ...
    wp_register_script( 'jquery1', get_template_directory_uri() . '/bower_components/jquery/dist/jquery.js', array( 'jquery' ), '3.6.0', true );
    wp_register_script( 'found1', get_template_directory_uri() . '/bower_components/foundation-sites/dist/foundation.js', array( 'jquery' ), '3.6.0', true );
    wp_register_script( 'waypoint', get_template_directory_uri() . '/bower_components/waypoints/lib/jquery.waypoints.min.js', array( 'jquery' ), '3.6.0', true );
...
function h5bs_footer_nav() {
    wp_nav_menu(array(
        ...
        'menu_class'      => 'nav-footer nav group menu align-right',       // custom class
...
function h5bs_register_sidebars() {
    ...
    register_sidebar(array(
        ...
        'name'          => 'Sidebar 3',
        'description'   => 'The first (primary) sidebar.',
        'before_widget' => '<div id="%1$s" class="each-fact %2$s">',
        'after_widget'  => '</div>',
